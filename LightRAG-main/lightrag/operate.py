            ...
            if entities_vdb is not None:
                ...
                vdb_data = {
                    entity_vdb_id: {
                        ...
                        "file_path": node_file_path,
                        # Evidence 证据链增强字段
                        "evidence_level": updated_relationship_data.get("evidence_level", "B") if updated_relationship_data else "B",
                        "scene_tags": [],
                        "source_provenance": [],
                    }
                }
    ...
    try:
        ...
        vdb_data = {
            rel_vdb_id: {
                ...
                # Evidence 证据链增强字段
                "relation_type": updated_relationship_data.get("relation_type", "related"),
                "evidence_level": updated_relationship_data.get("evidence_level", "B"),
                "source_provenance": updated_relationship_data.get("source_provenance", []),
            }
        }
