    ...
    *,
    ...
    if is_renaming:
        ...
        for src, tgt, edge_data in relations_to_update:
            ...
            # 获取证据链增强字段
            edge_evidence_level = edge_data.get("evidence_level", "B")
            edge_relation_type = edge_data.get("relation_type", "related")
            edge_source_provenance = edge_data.get("source_provenance", [])
            ...
            relation_data = {
                relation_id: {
                    ...
                    "evidence_level": edge_evidence_level,
                    "source_provenance": edge_source_provenance,
                }
            }
    ...
    # 获取证据链增强字段
    entity_evidence_level = new_node_data.get("evidence_level", "B")
    entity_scene_tags = new_node_data.get("scene_tags", [])
    entity_source_provenance = new_node_data.get("source_provenance", [])
    ...
    entity_data = {
        entity_id: {
            ...
            # Evidence 证据链增强字段
            "evidence_level": entity_evidence_level,
            "scene_tags": entity_scene_tags,
            "source_provenance": entity_source_provenance,
        }
            }
