        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="space-y-2">
            ...
            <div
              ...
              className="font-mono text-xs rounded-md bg-zinc-100 text-zinc-900 dark:bg-zinc-800 dark:text-zinc-100 p-3 overflow-y-auto overflow-x-hidden min-h-[7.5em] max-h-[40vh]"
            >
